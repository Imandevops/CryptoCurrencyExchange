...
- تو محیط پروداکشن بهتر حتی دیتابیس بیرون از کلاستر کوبرنتیز کلاستر بشه بخاطر مشکل io و پیچیدگی اپراتورها کوبرنتیز در مدیریت کلاستر دیتابیس به شخصه تجربی شخصیم بوده db  و هر چی  statefullset  هست نگهداریش بیرون کلاستر کوبرنتیز دردسر کم تری داره 
</div>
